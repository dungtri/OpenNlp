...
namespace ParseTree
{
	...
	public class MainForm : Form
	{
		...
		{
			this._lithiumControl = new LithiumControl();
			...
			this._lithiumControl.ConnectionType = ConnectionType.Default;
			this._lithiumControl.LayoutDirection = TreeDirection.Vertical;
