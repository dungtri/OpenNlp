	...
	public class MainForm : Form
	{
		...
		public MainForm()
		{
			...
			_modelPath = Path.Combine(
				...
				string.Join(Path.DirectorySeparatorChar, Enumerable.Repeat("..", 4)),
				string.Join(Path.DirectorySeparatorChar, "Resources", "Models", Path.DirectorySeparatorChar)
            );
		}
		...
		private void InitializeComponent()
		{
            ...
            this._txtIn.Text = resources.GetString("_txtIn.Text");
            // 
            // btnGender
            // 
